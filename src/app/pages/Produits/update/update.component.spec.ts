...
describe("modification des produits", () => {
    var component: UpdateComponent;

    beforeEach(() => {
        component = new UpdateComponent(new FormBuilder);
    });
    ...
    it('Devrait créer un formulaire avec 15 contrôles', () => {
        ...
        expect(component.form.contains('Unite')).toBeTruthy();
        expect(component.form.contains('Categorie')).toBeTruthy();
        expect(component.form.contains('idsociete')).toBeTruthy();
