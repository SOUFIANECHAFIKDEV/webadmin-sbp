...
var Calendar = /** @class */ (function () {
        ...
        switch (type) {
            ...
            case 1:
                if (direction === 1)
                    ...
                    if(this.inputFieldValue == null || this.inputFieldValue == ""){
                        this.inputFieldValue = this.formatDateTime(new Date())
                    }
                    this.inputFieldValue = this.inputFieldValue.substring(0,14) + (this.currentMinute.toString().length > 1 ? this.currentMinute : ('0'+this.currentMinute.toString()) )
                    this.inputfieldViewChild.nativeElement.value = this.inputFieldValue;
                    var str = this.inputFieldValue
                    this.updateModel(new Date(str.substr(6,4)+"-"+str.substr(3,2)+"-"+str.substr(0,2)+"T"+str.substr(11,2)+":"+str.substr(14,2)))
                }
                break;
            case 2:
                if (direction === 1)
    ...
    Calendar.prototype.incrementMinute = function (event) {
        ...
        if (this.validateMinute(newMinute)) {
            ...
            this.currentMinute = (this.currentMinute >= 30) ? 0 : 30;
        }
        event.preventDefault();
    };
